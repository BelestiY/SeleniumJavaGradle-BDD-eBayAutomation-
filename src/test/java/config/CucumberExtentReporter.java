...
public class CucumberExtentReporter {
    ...
    public CucumberExtentReporter(){
        ...
        extentHtmlReporter.config().setDocumentTitle("Gmail Test Automation");
        extentHtmlReporter.config().setReportName("Gmail Test Automation Report");
        extentHtmlReporter.config().setTheme(Theme.DARK);

        extentReports.setSystemInfo("Developed By", "Belesti Yenegeta");
        extentReports.setSystemInfo("Environment", "GMAIL TEST");
    ...
    public void createTest(Scenario scenario, WebDriver driver){
        if(scenario!=null){
            ...
            extentTest.assignAuthor("Automation-Quality-Engineer - Belesti Yenegeta");
...
//            writeException(scenario.get);
    ...
    public void startTest(String scenarioName){
        ...
        extentTest.assignAuthor("Automation-Quality-Engineer-Author: Belesti Yenegeta");
    }
